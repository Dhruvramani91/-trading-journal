...
export function LoginPage() {
  ...
  async function handleSignUp(e: React.FormEvent) {
    ...
    try {
      ...
      // Supabase sends the confirmation email automatically. Swap the form
      // out for a dedicated "check your inbox" screen instead of leaving
      // the user staring at the sign-up form with no feedback.
      setPassword('');
      ...
      <div className="max-w-md w-full space-y-6">
        ...
        <Card className="shadow-pop border-line bg-bg-2">
          <CardBody className="p-6 sm:p-8 space-y-6">
            ...
            {signupSuccess ? (
              /* ── Check Your Email screen (shown right after a successful sign-up) ── */
              <div className="text-center space-y-4 py-2">
                ...
                <div className="space-y-1.5">
                  ...
                  <p className="text-xs sm:text-sm text-fg-muted">
                    ...
                    <span className="font-medium text-fg">{email}</span>. Open it and
                    confirm your email to activate your account, then come back and log in.
                  </p>
                </div>
