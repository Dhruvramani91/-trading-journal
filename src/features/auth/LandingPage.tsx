...
/**
 * PrecisionJournal marketing landing page.
 *
...
(function(){
  ...
  function dashboardView(){
    ...
    return '<h2 class="ap-h">Welcome Back, <span class="ap-guest">Guest</span></h2>'+
...
(function(){
  ...
  function isDark(){
    var t=root.getAttribute('data-theme'); if(t) return t==='dark';
    return !!(window.matchMedia && window.matchMedia('(prefers-color-scheme: dark)').matches);
  }
  function label(){ btn.setAttribute('aria-label', isDark() ? 'Switch to light mode' : 'Switch to dark mode'); }
  label();
...
@media (prefers-color-scheme:dark){
  :root:not([data-theme="light"]){
    ...
    --text:#a9b2c3; --soft:#8b95a8; --gray-word:#5f6878;
...
.shell{
  max-width:1360px; margin:clamp(0px,3vw,40px) auto;
  background:var(--shell); border-radius:clamp(0px,3vw,40px);
...
/* hero */
.hero{text-align:center;padding-top:112px;padding-bottom:56px}
...
.sub{max-width:34ch;margin:28px auto 34px;color:var(--text);font-size:clamp(1rem,1.6vw,1.12rem)}
.proof{margin:14px 0 0;font-size:12px;color:var(--soft)}

/* stage + window */
.stage{
  position:relative; padding:clamp(16px,4vw,64px) clamp(12px,5vw,80px) 56px;
...
.shot{position:relative;max-width:1080px;margin:0 auto;border-radius:clamp(14px,2.2vw,22px);box-shadow:var(--shot-shadow)}
...
.steps::before{content:"";position:absolute;top:22px;left:50px;right:calc(33.3% - 22px);border-top:1.5px dashed var(--dot)}

/* pricing */
.dots{background-image:radial-gradient(var(--dot) 1.1px,transparent 1.2px);background-size:12px 12px}
.plans{display:grid;grid-template-columns:repeat(2,1fr);gap:16px;max-width:820px;margin:0 auto}
.plan{border-radius:28px;padding:32px;background:var(--card);box-shadow:inset 0 0 0 1px var(--line);display:flex;flex-direction:column;gap:20px}
...
@media (prefers-reduced-motion:reduce){
  *{transition:none!important;scroll-behavior:auto!important}
      ...
      <div className="shell">
        ...
        <header className="nav pad" id="home">
          <a className="logo" href="#home" aria-label="PrecisionJournal home">
            <img className="lg lg-light" src="data:image/png;base64," alt="" width="128" height="132" />
            <img className="lg lg-dark" src="data:image/png;base64," alt="" width="125" height="132" />
            PrecisionJournal
          </a>
          ...
          <div className="acct">
            <button className="theme" id="themeBtn" type="button" aria-label="Switch to dark mode">
              <svg className="i-moon" width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M21 12.8A9 9 0 1 1 11.2 3a7 7 0 0 0 9.8 9.8z"/></svg>
              <svg className="i-sun" width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="4"/><path d="M12 2v2M12 20v2M4.9 4.9l1.4 1.4M17.7 17.7l1.4 1.4M2 12h2M20 12h2M4.9 19.1l1.4-1.4M17.7 6.3l1.4-1.4"/></svg>
            </button>
            {user ? (
        ...
        <main>
          <section className="hero pad">
            <p className="eyebrow">A calmer way to trade</p>
            <h1>Journal your <span className="g">trades</span></h1>
            <p className="sub">A clean, simple trading journal that gamifies discipline and keeps you focused on what matters.</p>
          ...
          <section className="stage" aria-label="Product preview">
            <div className="shot">
              <div className="app" id="app">
                <aside className="side" aria-label="Demo navigation">
                  <div className="ap-brand"><span id="appLogo" className="logo"></span><span><b>PrecisionJournal</b><small>My Journal</small></span></div>
                  <button type="button" className="nav-i" data-nav="dashboard" aria-current="page"><svg viewBox="0 0 24 24"><rect x="3" y="3" width="7" height="7" rx="1.5"/><rect x="14" y="3" width="7" height="7" rx="1.5"/><rect x="3" y="14" width="7" height="7" rx="1.5"/><rect x="14" y="14" width="7" height="7" rx="1.5"/></svg>Dashboard</button>
                  <div className="ap-user"><i>G</i><span><b>Guest Trader</b><small>Demo with sample data. Add trades and watch the numbers change.</small></span></div>
                </aside>
                <div className="ap-main">
                  <div className="ap-tb">
                    <div><h3 id="tbTitle">Dashboard</h3><p id="tbSub">Overview of your trading performance</p></div>
                    <div className="ap-act">
                      <button type="button" data-act="reset">Reset demo</button>
                      <button type="button" className="ap-btn" data-act="new">+ New trade</button>
                    </div>
                  </div>
                  <div className="pane" id="pane"></div>
                </div>
                <dialog id="tradeDlg" aria-labelledby="dlgTitle">
                  <form id="tradeForm">
                    <h3 id="dlgTitle">New trade</h3>
                    <div className="ap-fields">
                      <label className="fld">Date<input type="date" name="date" required /></label>
                      <label className="fld">Symbol<input type="text" name="symbol" defaultValue="NQ" maxLength={12} required /></label>
                      <label className="fld">Setup<select name="setup"><option>SMT Break</option><option>Open DOL</option><option>Strength Switch</option></select></label>
                      <label className="fld">Side<select name="dir"><option>Long</option><option>Short</option></select></label>
                      <label className="fld">Result (R)<input type="number" name="r" step="0.25" placeholder="e.g. 2 or -1" required /></label>
                      <label className="fld">Planned R:R<input type="number" name="rr" step="0.1" min="0" defaultValue="2" /></label>
                      <label className="fld">Duration (minutes)<input type="number" name="dur" step="1" min="0" defaultValue="45" /></label>
                    </div>
                    <div className="ap-dact"><button type="button" className="ap-ghost" data-act="cancel">Cancel</button><button type="submit" className="ap-btn">Save trade</button></div>
                  </form>
                </dialog>
              </div>
            </div>
          ...
          <section className="sec pad" id="features">
            ...
            <div className="bento">
              ...
              <article className="cell white c-c">
              ...
              <article className="cell white c-d">
              ...
              <article className="cell white c-e">
          ...
          <section className="sec pad dots" id="about">
            <div className="head">
              <h2>Three steps, <span className="g">every trading day</span></h2>
          ...
          <section className="sec pad" id="pricing">
            <div className="head">
              <h2>Free to use, <span className="g">while we test</span></h2>
              <p>PrecisionJournal is still in testing. Use everything for free while we shape it with your feedback.</p>
            </div>
            <div className="plans">
              ...
              <article className="plan feat">
                ...
                <p className="soonp">We're still testing PrecisionJournal with traders like you. Pricing will be announced here soon.</p>
                <p className="soonp">Nothing to pay while PrecisionJournal is in testing.</p>
              </article>
            </div>
          ...
          {/* FAQ */}
          <section className="sec pad dots" id="faq">
            <div className="head"><h2>Questions, <span className="g">answered</span></h2></div>
            <div className="faq">
              <details open><summary>What does the discipline score measure?</summary><p>It shows how closely you followed the GXT or Lathyrus model on each trade. It rewards process, so a losing trade you handled well still counts.</p></details>
              <details><summary>Do I need to know the models already?</summary><p>No. If you're still learning the GXT or Lathyrus style, PrecisionJournal helps you track your learning and your trades as you go.</p></details>
              <details><summary>How much does PrecisionJournal cost?</summary><p>PrecisionJournal is free to use while it's in testing. Pricing will be announced soon.</p></details>
              <details><summary>Can I journal trades from different markets?</summary><p>Yes. Log futures or forex with the same routine, and compare results by setup or day of the week.</p></details>
            </div>
          </section>
        ...
        <footer className="pad">
          ...
          <nav aria-label="Footer"><a href="#about">About</a><a href="#pricing">Pricing</a><a href="#faq">FAQ</a></nav>
        </footer>
      </div>
    </>
  );
